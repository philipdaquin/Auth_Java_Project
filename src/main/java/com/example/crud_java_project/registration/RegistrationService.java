...
import com.example.crud_java_project.email.EmailSender;
import com.example.crud_java_project.registration.token.ConfirmationToken;
import com.example.crud_java_project.registration.token.ConfirmationTokenService;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) throws Exception {
        ...
        // Generate token
        System.out.printf("\n 🤠 Generating token for user %s", request.getEmail());
    ...
    public String confirmToken(String token) { 
        ...
        System.out.printf("\n ✅ Checking user confirmation token");        
        ...
        // enable user after confirmaiton
